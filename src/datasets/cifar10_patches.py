...
class CIFAR10Patches(Dataset):
    def __init__(self, train: bool = True):
        raw               = datasets.CIFAR10('../data', train=train, download=True,
        ...
        self.wh_cifar10   = images[:, 0]       # (num_images, H, W)
        self.num_samples  = 10000
        self.patch_size   = 8
        image_height      = self.wh_cifar10.shape[1]
        image_width       = self.wh_cifar10.shape[2]
